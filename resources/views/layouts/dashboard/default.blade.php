...
<head>
    ...
    <meta name="description"
        content="Qompac UI – free bootstrap 5 admin dashboard template comes with over 200+ elements finely crafted to speed up your development cycles. Production Ready Premium Dashboard UI Kit And Design System">
    <meta name="keywords"
...
<body class="">
    ...
    <main class="main-content">
        ...
        <!-- Page Content Start-->
        <div class="content-inner container pb-0">
            {{ $slot }}
        </div>
        <!-- Page Content End-->
